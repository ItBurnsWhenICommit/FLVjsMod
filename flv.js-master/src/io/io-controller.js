...
class IOController {
    ...
    constructor(dataSource, config, extraData) {
        ...
        this._bufferSize = this._stashInitialSize;
    ...
    pause() {
        if (this.isWorking()) {
            ...
            if (this._stashUsed !== 0) {
                ...
                this._currentRange.to = this._stashByteStart - toNumber;
            } else {
                this._resumeFrom = this._currentRange.to + toNumber;
            }
            this._stashUsed = 0;
            this._stashByteStart = 0;
            this._paused = true;
    ...
    _dispatchChunks(chunks, byteStart) {
        this._currentRange.to = byteStart + chunks.byteLength - toNumber;
            ...
            case LoaderErrors.EARLY_EOF: {
                if (!this._config.isLive) {
                    ...
                    if (this._totalLength) {
                        let nextFrom = this._currentRange.to + toNumber;
